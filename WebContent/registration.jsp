				...
				<div class="signup-content">
					<div class="signup-form">
						...
						<form method="POST" action="" class="register-form"
							...
							<input type="button" value="Set Email as Username" onclick="myFunction()">
							<div class="form-group">
								<label for="phone"><i class="zmdi zmdi-phone-msg"></i></label> <input
							...
							<div class="form-group">
								<label for="address"><i class="zmdi zmdi-walk"></i></label> <input
